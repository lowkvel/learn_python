...
urlpatterns = [
    ...
    path('snippets/', views.SnippetList.as_view()),     # used with snippet_list views v3 and v4

    #path('snippets/<int:pk>/', views.snippet_detail),            # used with snippet_detail views v1 and v2
    path('snippets/<int:pk>/', views.SnippetDetail.as_view()),    # used with snippet_detail views v3 and v4
